...
function motion(frame, delay) {
  ...
  return {
    opacity: (0,esm.interpolate)(progress, [0, 1], [0, 1], clamp),
    translateY: (0,esm.interpolate)(progress, [0, 1], [24, 0], clamp)
  };
}
function CardsDeck({ title, subtitle, cards }) {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              position: "absolute",
              inset: 0,
              background: "radial-gradient(circle at 20% 18%, rgba(78,230,255,0.14), transparent 28%), radial-gradient(circle at 82% 14%, rgba(255,127,98,0.12), transparent 26%), radial-gradient(circle at 50% 86%, rgba(255,209,102,0.09), transparent 32%)"
            }
          }
        ),
...
(0,esm.registerRoot)(CardsAgentRoot);
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "cards-agent:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcards_agent"] = self["webpackChunkcards_agent"] || [];
